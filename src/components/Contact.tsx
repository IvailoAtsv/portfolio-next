              ...
              <div className="relative z-10">
                ...
                <div className="mt-12 flex space-x-4">
                  <Link
                    ...
                    className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-purple-500/30 transition-colors hover:bg-purple-500/50"
                  >
                    <Github />
                  </Link>
                  <Link
                ...
                >
                  ...
                  <div className="flex items-center justify-center pt-6">
                    <CTAButton
                      ...
                      className="flex w-full items-center justify-center px-12 text-center"
                      aria-label={
                        isSubmitting
                          ? 'Sending message...'
